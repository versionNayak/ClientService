...
public class TransactionReportDTO {
	...
	private List<TransactionReportDetailedDTOSecondOption> dataSourceList;
	
	public TransactionReportDTO() {
		
	}
	
	public TransactionReportDTO(String transactionDate, String transTypeCode, String nav,
			String transUnits) {
	...
	public List<TransactionReportDetailedDTOSecondOption> getDataSourceList() {
		return dataSourceList;
	}

	public void setDataSourceList(List<TransactionReportDetailedDTOSecondOption> dataSourceList) {
		this.dataSourceList = dataSourceList;
	}

	@Override
	public String toString() {
		return "TransactionReportDTO [logo=" + Arrays.toString(logo) + ", clientId=" + clientId + ", nameClient="
				+ nameClient + ", fromDate=" + fromDate + ", toDate=" + toDate + ", fundHouse=" + fundHouse
				+ ", schemeName=" + schemeName + ", distributorName=" + distributorName + ", distributorEmail="
				+ distributorEmail + ", distributorMobile=" + distributorMobile + ", distributorAddress="
				+ distributorAddress + ", distributorContactDetails=" + distributorContactDetails + ", familyName="
				+ familyName + ", addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2 + ", addressLine3="
				+ addressLine3 + ", clientPAN=" + clientPAN + ", clientEmail=" + clientEmail + ", clientPhNo="
				+ clientPhNo + ", clientMobile=" + clientMobile + ", runningTotal=" + runningTotal + ", status="
				+ status + ", familyMemberIdArr=" + Arrays.toString(familyMemberIdArr) + ", folioShemeMap="
				+ folioShemeMap + ", folioNo=" + folioNo + ", transactionDate=" + transactionDate + ", transTypeCode="
				+ transTypeCode + ", nav=" + nav + ", transUnits=" + transUnits + ", summaryMap=" + summaryMap
