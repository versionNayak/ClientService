...
public class PortfolioValuationReportDTO {
	...
	private Map<String, List<PortfolioValuationReportColumnDTO>> folioSchemeMap;
	...
	public Map<String, List<PortfolioValuationReportColumnDTO>> getFolioSchemeMap() {
		return folioSchemeMap;
	}

	public void setFolioSchemeMap(Map<String, List<PortfolioValuationReportColumnDTO>> folioSchemeMap) {
		this.folioSchemeMap = folioSchemeMap;
	}

	@Override
	public String toString() {
		return "PortfolioValuationReportDTO [logo=" + Arrays.toString(logo) + ", clientId=" + clientId + ", nameClient="
				+ nameClient + ", asOnDate=" + asOnDate + ", fundHouse=" + fundHouse + ", distributorName="
				...
				+ ", schemeName=" + schemeName + ", familyMemberIdArr=" + Arrays.toString(familyMemberIdArr)
				+ ", folioSchemeMap=" + folioSchemeMap + "]";
	}
