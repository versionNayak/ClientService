...
public class TransactionReportDetailedDTOSecondOption {
	...
	private Map<String,List<TransactionReportColumnDTO>> mainReportMap;
	...
	public Map<String, List<TransactionReportColumnDTO>> getMainReportMap() {
		return mainReportMap;
	}

	public void setMainReportMap(Map<String, List<TransactionReportColumnDTO>> mainReportMap) {
		this.mainReportMap = mainReportMap;
	}
