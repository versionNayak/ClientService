...
public class CapitalGainsReportDTO {
	...
	private Map<String, List<CapitalGainsReportColumnDTO>> folioSchemeMap;
	
	public CapitalGainsReportDTO() {
	...
	public Map<String, List<CapitalGainsReportColumnDTO>> getFolioSchemeMap() {
		return folioSchemeMap;
	}

	public void setFolioSchemeMap(Map<String, List<CapitalGainsReportColumnDTO>> folioSchemeMap) {
	...
	public String toString() {
		return "PortfolioGainLossReportDTO [logo=" + Arrays.toString(logo) + ", clientId=" + clientId + ", nameClient="
				...
				+ clientMobile + ", schemeName=" + schemeName + ", familyMemberIdArr="
				+ Arrays.toString(familyMemberIdArr) + ", folioSchemeMap=" + folioSchemeMap + "]";
	}
