...
public class CurrentHoldingReportDTO {
	...
	private Map<String,List<CurrentHoldingReportColumnDTO>> schemeMap;
	private Integer[] familyMemberIdArr;
	
	public CurrentHoldingReportDTO() {
	...
	public Map<String, List<CurrentHoldingReportColumnDTO>> getSchemeMap() {
		return schemeMap;
	}

	public void setSchemeMap(Map<String, List<CurrentHoldingReportColumnDTO>> schemeMap) {
	...
	public String toString() {
		return "CurrentHoldingReportDTO [logo=" + Arrays.toString(logo) + ", clientId=" + clientId + ", nameClient="
				+ nameClient + ", fromDate=" + fromDate + ", toDate=" + toDate + ", asOnDate=" + asOnDate
				+ ", fundHouse=" + fundHouse + ", schemeName=" + schemeName + ", distributorName=" + distributorName
				...
				+ distributorMobile + ", familyName=" + familyName + ", addressLine1=" + addressLine1
				...
				+ ", schemeMap=" + schemeMap + ", familyMemberIdArr=" + Arrays.toString(familyMemberIdArr) + "]";
	}
